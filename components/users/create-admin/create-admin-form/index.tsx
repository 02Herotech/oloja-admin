    ...
    return (
        <FormProvider {...methods}>
            <div
                ...
                className="p-8 max-w-3xl bg-white rounded-lg"
            >
                <h1 className="text-3xl font-bold mb-2 text-primary">Create New
                                                                     Admin</h1 >
                ...
                >
                    ...
                    <div
                        className="grid grid-cols-2 gap-6 align-middle items-center"
                    >
                        <Input
                        ...
                        <div >
                            <label
                                className="block text-sm font-satoshiMedium"
                            >Role</label >
                            <div className="mt-1 relative">
                                <select
                                    {...methods.register("role", {required: "Role is required"})}
                                    className="w-full text-sm md:text-base px-5 py-3 border border-gray-300 rounded-xl focus:outline-none appearance-none bg-white"
                                >
                                ...
                                <MdArrowDropDown
                                    className="absolute top-3 right-0 md:right-3 md:top-3 text-gray-500 pointer-events-none"
                                    size={24}
                            ...
                            {errors.role &&
                              <span
                                className='text-sm flex items-center space-x-1 mt-2 text-status-error-100'
                              >
                        <MdErrorOutline
                          className="text-status-error-100 h-5 w-5"
                        />
                        <h6 >{errors.role?.message}</h6 >
                    </span >}
                    ...
                    <div className="flex justify-end">
                        <Button
                            type="submit"
                            className="w-full max-w-[200px] bg-primary text-white py-2 px-4 rounded-full hover:bg-primary/90"
                        >
                            {isLoading ? <Loader2
            ...
            <Modal show={showModal} onRequestClose={() => setShowModal(false)}>
                <div className="p-2 text-center">
                    <div
                        className="w-16 h-16 mx-auto bg-green-100 flex items-center justify-center rounded-full"
                    >
                        <Image
                            src={ModalSuccessImage}
                            alt={"success"}
                            width={20}
                            height={20}
                        />
                    ...
                    <p className="mt-2 font-satoshi text-[#140B31]">The admin
                                                                    has been
                                                                    successfully
                                                                    added
